    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="container-fluid">
                ...
                <br />
                <asp:Label ID="lbl_mensajeDos" runat="server" Text="" ForeColor="Green"></asp:Label>
                <div class="form row">
        ...
        <asp:Button ID="btn_Modify_Agen" runat="server" Text="Modificar" CssClass="btn btn-warning" Width="230px" OnClick="btn_Modify_Agen_Click" Visible="false" />
                &nbsp;
        <asp:Button ID="btn_Limpiar" runat="server" Text="Limpiar" CssClass="btn btn-info" Width="230px" OnClick="btn_Limpiar_Click" />
                <br>
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
