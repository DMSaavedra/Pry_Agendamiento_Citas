    ...
    <div class="container-fluid">
        ...
        <div class="form row">
            <div class="col-md-3 mb-3">
                ...
                <asp:TextBox ID="txt_especialidad" runat="server" class="form-control" onKeypress="if ((event.keyCode != 32) && (event.keyCode < 65) || (event.keyCode > 90) && (event.keyCode < 97) || (event.keyCode > 122)) event.returnValue = false;" onkeyup="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()"></asp:TextBox>
            </div>
            <div class="col-md-3 mb-3">
                <label>Descripcion Especialidad</label>
                <asp:TextBox ID="txt_despecialidad" runat="server" class="form-control" onKeypress="if ((event.keyCode != 32) && (event.keyCode < 65) || (event.keyCode > 90) && (event.keyCode < 97) || (event.keyCode > 122)) event.returnValue = false;" onkeyup="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()"></asp:TextBox>
            </div>
            <div class="col-md-3 mb-3">
                <label>Edad Dirigida</label>
                <asp:DropDownList ID="ddl_edad" runat="server" class="form-control" Style="height: 1.2cm;">
            ...
            <div class="col-md-3 mb-3">
                ...
                <asp:DropDownList ID="ddl_consultorio" runat="server" class="form-control" Style="height: 1.2cm;"></asp:DropDownList>
            </div>
        </div>
        <br>
