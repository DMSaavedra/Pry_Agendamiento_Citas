<%@ Page Title="" Language="C#" MasterPageFile="~/Template/Page.Master" AutoEventWireup="true" CodeBehind="List_Paciente.aspx.cs" Inherits="Pry_Agendamiento_Citas.Template.List_Paciente" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="container-fluid">
                <asp:GridView ID="grv_paciente" runat="server" CssClass="table table-bordered table-responsive" AutoGenerateColumns="False" OnRowCommand="grv_paciente_RowCommand" CellPadding="4" ForeColor="#333333" GridLines="None">
